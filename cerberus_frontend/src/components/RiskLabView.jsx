...
import { BarChart3, Sliders, Cpu, ShieldCheck, AlertCircle } from 'lucide-react';

export default function RiskLabView({ metrics }) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span>— Honest offline evaluation on held-out stratified test data.</span>
        </div>
        <span className="mono" style={{ fontSize: '11px', color: 'var(--text-muted)' }}>
          Model: Gradient Boosting Classifier v1.0.0
        </span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1.8fr', gap: '1.5rem' }}>
        ...
        <div className="fintech-card" style={{ padding: '1.25rem' }}>
          ...
          <div style={{ marginTop: '1.25rem', borderTop: '1px solid var(--border-subtle)', paddingTop: '1rem' }}>
            ...
            />
            <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '4px' }}>
              Optimized to minimize total merchant friction cost vs fraud loss.
            </div>
          </div>
        </div>
